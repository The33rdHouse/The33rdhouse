          ...
          {!searchQuery && !isLoading && (
            <Tabs defaultValue="featured" className="space-y-8">
              <div className="overflow-x-auto -mx-4 px-4 pb-4">
                <TabsList className="bg-purple-950/30 border border-purple-900/30 inline-flex w-auto min-w-full md:min-w-0 gap-2 p-2">
                  <TabsTrigger value="featured" className="whitespace-nowrap px-4 py-2 data-[state=active]:bg-purple-600 data-[state=active]:text-white">Featured</TabsTrigger>
                  <TabsTrigger value="codex" className="whitespace-nowrap px-4 py-2 data-[state=active]:bg-purple-600 data-[state=active]:text-white">Codex ({codexBooks.length})</TabsTrigger>
                  <TabsTrigger value="curriculum" className="whitespace-nowrap px-4 py-2 data-[state=active]:bg-purple-600 data-[state=active]:text-white">Curriculum ({curriculumBooks.length})</TabsTrigger>
                  <TabsTrigger value="guides" className="whitespace-nowrap px-4 py-2 data-[state=active]:bg-purple-600 data-[state=active]:text-white">Guides ({guideBooks.length})</TabsTrigger>
                  <TabsTrigger value="manuals" className="whitespace-nowrap px-4 py-2 data-[state=active]:bg-purple-600 data-[state=active]:text-white">Manuals ({manualBooks.length})</TabsTrigger>
                  <TabsTrigger value="institute" className="whitespace-nowrap px-4 py-2 data-[state=active]:bg-purple-600 data-[state=active]:text-white">Institute ({instituteBooks.length})</TabsTrigger>
                </TabsList>
              </div>
